  ...
  (setq-default
   ...
   '(python
     ...
     (org :variables
          ...
          org-default-notes-file (concat org-directory "/org-roam/notes.org")
...
before packages are loaded."
  ...
  (spacemacs/set-leader-keys "ojj" 'org-roam-dailies-capture-today)
  (spacemacs/set-leader-keys "ojt" 'org-roam-dailies-find-today)
  (spacemacs/set-leader-keys "ojf" 'org-roam-dailies-find-date)
  (spacemacs/set-leader-keys "ojp" 'org-roam-dailies-goto-previous-note)
  (spacemacs/set-leader-keys "ojn" 'org-roam-dailies-goto-next-note)
  ...
  (spacemacs/set-leader-keys "orv" 'org-roam-node-visit)
  (spacemacs/set-leader-keys "orl" 'org-roam-buffer-toggle)
  (spacemacs/set-leader-keys "orc" 'org-roam-capture)
  (spacemacs/set-leader-keys "ord" 'org-download-clipboard)
  (spacemacs/set-leader-keys "ort" 'org-roam-tag-add)
  (spacemacs/set-leader-keys "ora" 'org-roam-alias-add)

  (setq dotspacemacs-auto-save-file-directly t)
...
(defun aylei/configure-org-mode ()
  ...
  (setq org-cycle-separator-lines lines 1)
  ...
  (setq org-agenda-files '("~/Documents/org/org-roam/notes.org"))
